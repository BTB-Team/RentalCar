...
export const Footer = () => {
  ...
  const content = {
    ...
    en: {
      ...
      subtext:
        "Providing car rental services and travel support in Afghanistan",
        ...
        <div className="flex flex-col gap-4 items-start w-[307px]">
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            >
              ...
              >
                <path
                  d="M29.213 9.427a3.653 3.653 0 0 0-2.573-2.587C24.36 6.2 16 6.2 16 6.2s-8.36 0-10.64.64A3.653 3.653 0 0 0 2.787 9.427C2.16 11.72 2.16 16 2.16 16s0 4.28.627 6.573a3.653 3.653 0 0 0 2.573 2.587c2.28.64 10.64.64 10.64.64s8.36 0 10.64-.64a3.653 3.653 0 0 0 2.573-2.587C29.84 20.28 29.84 16 29.84 16s0-4.28-.627-6.573Z"
                  stroke="black"
                  strokeWidth="2.5"
                  strokeLinecap="round"
            ...
            >
              ...
              >
                <path
                  d="M22.1335 7.76C21.2223 6.71937 20.7201 5.3832 20.7202 4H16.6002V20.5333C16.5691 21.4283 16.1916 22.2761 15.5473 22.898C14.903 23.5199 14.0423 23.8672 13.1469 23.8667C11.2535 23.8667 9.68021 22.32 9.68021 20.4C9.68021 18.1067 11.8935 16.3867 14.1735 17.0933V12.88C9.57354 12.2667 5.54688 15.84 5.54688 20.4C5.54688 24.84 9.22688 28 13.1335 28C17.3202 28 20.7202 24.6 20.7202 20.4V12.0133C22.3909 13.2131 24.3967 13.8569 26.4535 13.8533V9.73333C26.4535 9.73333 23.9469 9.85333 22.1335 7.76Z"
                  fill="black"
                />
              </svg>
            </a>
