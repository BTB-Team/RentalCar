        ...
        <div className="flex flex-col gap-4 items-start w-[307px]">
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            <a
              ...
              className="w-[41px] h-[41px] bg-[#FFD000] rounded-full flex items-center justify-center hover:opacity-80 transition-opacity"
            >
