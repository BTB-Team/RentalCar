                ...
                {carouselTestimonials.map((testimonial, index) => (
                  ...
                  >
                    ...
                    <div className="flex w-full items-start gap-[12px]">
                      {" "}
                      <span
                        className={`flex h-[29px] w-[35px] items-center justify-center text-[34px] font-bold leading-none text-[#F7D102] ${isDari ? "order-1" : "order-2"}`}
                      >
                        {" "}
                        “{" "}
                      </span>{" "}
                      <div
                        className={`flex min-w-0 flex-1 items-center gap-[12px] ${isDari ? "text-right" : "text-left"}`}
                      >
                        {" "}
                        {testimonial.avatar ? (
                          <img
                        ...
                        <div className="min-w-0 flex-1">
                          {" "}
                          <h3
                            className={`m-0 text-[16px] font-semibold leading-[25px] text-black ${isDari ? "text-right" : "text-left"}`}
                          >
                            {" "}
                            {(isDari
                              ? testimonial.name_dr
                          ...
                          <p
                            className={`m-0 text-[13px] font-light leading-[20px] text-black ${isDari ? "text-right" : "text-left"}`}
                          >
                            {" "}
                            {(isDari
                              ? testimonial.role_dr
                    ...
                    <p
                      className={`m-0 mt-[16px] flex-1 break-words text-[13px] font-normal leading-[20px] text-black ${isDari ? "text-right" : "text-left"}`}
                    >
                      {" "}
                      {(isDari
