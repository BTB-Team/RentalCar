    ...
    <section className="bg-white px-4 py-10 sm:px-6 lg:px-8" dir="rtl">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-8 text-center">
          <h2 className="mx-auto min-h-[62px] w-full max-w-[653px] text-center font-yekan text-[28px] font-black leading-[120%] tracking-[0px] text-black sm:text-[34px] sm:leading-[110%] lg:h-[62px] lg:text-[40px] lg:leading-[100%]">
        ...
        <div className="mx-auto grid h-auto w-full max-w-full grid-cols-1 gap-[20px] overflow-hidden rounded-[20px] sm:grid-cols-2 lg:grid-cols-2 xl:h-[285px] xl:w-[1200px] xl:grid-cols-4">
          {processSteps.map((step) => (
            ...
            >
              ...
              <div className="absolute bottom-[5px] left-1/2 z-10 h-[123px] w-[calc(100%-24px)] max-w-[258px] -translate-x-1/2 text-right text-white xl:w-[258px]">
                ...
                <h3 className="h-[31px] w-full text-right font-yekan text-[20px] font-bold leading-[100%] tracking-[0%] text-white">
                  {step.title}
                </h3>

                <p className="h-[54px] w-full text-right font-yekan text-[14px] font-normal leading-[150%] tracking-[0%] text-white">
                  {step.description}
                </p>
              </div>
            </div>
