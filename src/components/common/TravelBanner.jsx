...
export const TravelBanner = ({ cta }) => {
  ...
  return (
    <div className="relative w-full h-[250px] md:h-[339px] mt-20 rounded-2xl flex items-center justify-center overflow-hidden select-none bg-gradient-to-r from-brand-yellow/10 via-brand-yellow/40 to-brand-yellow/90">
      {/* background car image overlay */}
      <div
        className="absolute inset-0 w-full h-full bg-center bg-no-repeat bg-contain opacity-25 pointer-events-none mix-blend-multiply"
        style={{
