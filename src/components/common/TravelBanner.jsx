...
export const TravelBanner = ({ cta }) => {
  ...
  return (
    <div className="relative my-8 w-full h-[220px] sm:h-[280px] md:h-[339px] rounded-2xl flex items-center justify-center overflow-hidden opacity-2 select-none bg-gradient-to-r from-brand-yellow/10 via-brand-yellow/40 to-brand-yellow/90">
