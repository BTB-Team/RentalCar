...
export const CtaBanner = () => {
    ...
    return (
        <section className="w-full my-24 px-4">
            <div className="bg-[#EEEEEE] rounded-[20px]  xl:w-[1200px] mx-auto  h-auto lg:h-[210px] flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-8 px-6 lg:px-24 py-8 lg:py-0">

                {/* Icon circle — 117x117, 3px yellow border */}
                <div className="w-[100px] h-[100px] lg:w-[110px] lg:h-[110px] shrink-0 rounded-full border-[3px] border-brand-yellow flex items-center justify-center order-1">
                    <svg width="79" height="79" viewBox="0 0 67 67" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <div className={`flex-1 space-y-2 order-2 ${lang === 'dr' ? 'text-center md:text-right' : 'text-center md:text-left'}`}>
                    <h3 className="font-sans font-extrabold text-brand-black text-[20px] lg:text-[24px] leading-snug">
                        {lang === 'dr'
                            ? 'برای رزرو این موتر همین امروز با ما تماس بگیرید'
                            : 'Contact us today to book this car'}
                    </h3>
                    <p className="font-sans font-semibold text-brand-black text-[14px] lg:text-[16px]">
                        {lang === 'dr'
                ...
                <a
                    ...
                    className="w-full lg:w-[209px] h-[60px] shrink-0 bg-brand-black text-white font-sans font-semibold text-[18px] md:text-[20px] rounded-[58px] flex items-center justify-center gap-2 hover:opacity-90 transition-opacity order-3"
                >
                    <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6 font-bold">
                        <path
