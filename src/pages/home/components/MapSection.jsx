...
export const MapSection = () => {
  ...
  // آدرس نقشه دفتر کابل
  const googleMapUrl = "https://share.google/rLyBD7EhRnQtmFX1W";
  ...
  return (
    <section className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-16 select-none bg-white">
      ...
      <div className="w-full max-w-[1200px] mx-auto rounded-[20px] overflow-hidden shadow-sm h-[260px] sm:h-[300px] relative z-10 transition-all duration-300">
        <iframe
          src={googleMapUrl}
          width="100%"
          height="100%"
